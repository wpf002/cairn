...
const WEEKS: readonly WeekEntry[] = [
  { week: 4, title: 'Implantation and beginnings', body: 'The embryo has implanted in the lining of the uterus. The neural tube — the structure that becomes the brain and spinal cord — is beginning to form, and the placenta is starting to develop.' },
  ...
  { week: 13, title: 'Vocal cords and fingerprints', body: 'Vocal cords are forming, and unique fingerprints are already set. The second trimester is beginning; the fetus is about three inches long.' },
  ...
  { week: 24, title: 'Lung development', body: 'The lungs are developing the cells that will make surfactant, the substance that lets air sacs inflate. The fetus weighs over a pound.' },
  { week: 25, title: 'Startle and settle', body: 'The fetus may respond to loud sounds with a startle, and may settle to familiar rhythms. Hands can grip.' },
  ...
  { week: 33, title: 'Immune transfer', body: 'Antibodies are crossing the placenta, lending the baby immune protection for the first months of life. The pupils constrict and dilate in response to light.' },
  ...
  { week: 36, title: 'Running out of room', body: 'Growth continues but space is tight; movements feel different, though their frequency should not decrease. The baby is likely settling into the birth position.' },
  ...
  { week: 40, title: 'Due', body: 'The estimated due date — an estimate: only about one in twenty babies arrives on it, and most come within two weeks either side.' },
];
